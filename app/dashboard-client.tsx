...
export default function Home() {
  ...
  function fillQuickReply(template: string) {
    ...
    const replies: Record<string, string> = {
      ...
      sexting_5_minutes: `The 5 minute sexting package is ${settings.sexting_5_stars || "500"} Stars, babe. Do you want that one?`,
      sexting_10_minutes: `The 10 minute sexting package is ${settings.sexting_10_stars || "1000"} Stars, babe. Do you want that one?`,
