...
export default function Home() {
  ...
  function fillQuickReply(template: string) {
    ...
    const replies: Record<string, string> = {
      ...
      content_disclaimer: "This content is for your personal viewing only. You do not have permission to post, share, resell, redistribute, or upload any paid content anywhere.",
