...
async function handleAdminTraining(request: Request, env: Env, url: URL) {
  ...
  if (request.method === "POST" && url.pathname === "/api/admin/training") {
    ...
    const allowedCategories = ["topic", "fact", "like", "dislike", "voice", "avoid", "tone", "feedback"];
